...
# must put images onto a "surface" and then place surfaces onto the screen
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            ...
            exit()
        if game_active:
            # spawns snail or fly obstacle randomly
...
# displays surfaces at coordinate values on the screen
    if game_active:
